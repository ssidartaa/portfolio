...
const SheetOverlay = ({
  ...
  <SheetPrimitive.Overlay
    ...
    className={cn(
      "z-50 fixed inset-0 bg-black/10 supports-backdrop-filter:backdrop-blur-xs data-closed:animate-out data-open:animate-in duration-300 data-open:fade-in-0 data-closed:fade-out-0",
      className,
    )}
    {...props}
  />
